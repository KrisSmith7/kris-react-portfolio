...
import bioImage from "../../assets/images/page-graphics/bio-pic.jpg"
                ...
                <div className="inline-grid">
                    ...
                    <div className="flex justify-center hidden lg:block lg:mx-2 lg:mb-0">
                        <img src={bannerImage} alt="Kris Smith"
                            ...
                            <div className="bg-dark-orange rounded-md m-2 mb-0 hidden lg:block"><span className="inline leading-loose text-center text-gray px-4">“There's so much creativity in brokeness. Brokeness will have you making it work.” -Issa Rae</span></div>
                </div>

                    <div className="bg-royal-purple rounded-md w-1/3 px-4 pt-4 text-gray">
                        <div className="flex flex-col h-full justify-center items-center">
                        <h1 className="text-3xl">Who's That Girl?</h1>
                        <p className="leading-loose text-center">Howdy! I love building big, bold, and beautiful applications. Web dev can be challenging, but I love the logic and complexities behind it and have always been fascinated by the amazing things we can create. Takes beauty, brains, and a little magic to build to code and I am here for it. <br /> If I'm not behind a computer, you can usually find me with my family -- watching a game, relaxing in the mountains, or hunting down a good trivia spot.</p>
                       </div>
                    </div>
            </div>
        </section>
